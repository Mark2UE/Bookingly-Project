    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample03">
            <ul class="navbar-nav flex-wrap">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="index.php">RENT</a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav flex-wrap ms-md-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link bi-person-circle" aria-current="page" href="" data-bs-toggle="modal" data-bs-target="#modal1">LOGIN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="index.php">SIGNUP</a>
                </li>
            </ul>
        </div>
    </div>
                                            ...
                                            <div class="container-fluid my-5 text-black fs-5">
                                                <form action="account.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="floatingInput" placeholder="username" name="StudentNumber" required>
                                                    ...
                                                    <div class="form-floating">
                                                        <center>
                                                            ...
                                                            <button type="submit" name="login" class="btn btn-warning px-5 btn-custom" style="width: 300px;">Login</button>
                                                            <br> <br>
